...
2. `public/_remotes` 用于存放[远程引用文档](/usage/reference.md)关联的静态资源，请勿直接依赖该目录的资源，可以将 `*/public/_remotes` 加入 `.gitignore` 避免提交到代码仓库
...
在文档正文中，参考 [MDX](/usage/mdx.md) 使用 `.mdx` 文件时可以使用 `frontmatter` 来访问这些元数据。

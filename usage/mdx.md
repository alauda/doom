...
同 [Callouts](/usage/markdown.md#callouts) Markdown 扩展功能，源码标注组件
...
同 [Callout](/usage/markdown.md#callout) Markdown 扩展功能，代码块外独立标注组件
...
Note因为 DevOps 连接器的发版周期与灵雀云容器平台不同，所以 DevOps 连接器的文档现在作为独立的文档站点托管在 [DevOps 连接器](/devops-connectors/)。
### `ExternalSiteLink`
...
[Content](/devops-connectors/link#hash)
:::tip
...
Note关于 ACP  APIs 的使用方法介绍请参考 [ACP APIs 指南](/container_platform/apis/overview/)。
Note关于 DevOps 连接器 APIs 的使用方法介绍请参考 [DevOps 连接器 APIs 指南](/devops-connectors/apis/overview/)。
### Term

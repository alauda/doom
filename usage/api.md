...
参考 [DaemonSet](/apis/kubernetes_apis/workload/daemonset.md)。
...
参考 [CodeQualityTaskSummary](/apis/advanced_apis/codeQualityTaskSummary.md)。
...
参考 [ArtifactCleanupRun-K8sCrd](/apis/crds/ArtifactCleanupRun-K8sCrd.md)。

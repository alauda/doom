const en = {
  ...
  available_api_endpoints: 'The following API endpoints are available:',
...
const zh: Translation = {
  ...
  available_api_endpoints: '可用的 API 端点如下：',
  http_method: 'HTTP 方法',
  http_responses: 'HTTP 响应',
  http_code: 'HTTP 状态码',
  response_body: '响应体',
  query_parameters: '查询参数',
  body_parameters: '请求体参数',
  parameter: '参数',
  parameters: '参数',
  common_parameters: '公共参数',
  request_body: '请求体',
  response: '响应',
...
const ru: Translation = {
  ...
  api_endpoints: 'API конечные точки',
  available_api_endpoints: 'Доступны следующие API конечные точки:',
  http_method: 'HTTP метод',
  http_responses: 'HTTP ответы',
  http_code: 'HTTP код',
  ...
  common_parameters: 'Общие параметры',

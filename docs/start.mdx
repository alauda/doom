...
Options:
  ...
  --no-open [boolean]             Do not open the browser after starting the server
...
Options:
  -s, --source <language>  Document source language (default: "en")
  -t, --target <language>  Document target language (default: "zh")

...
## [#](#_r_8c_-platformeventsalaudaiov1events)/platform/events.alauda.io/v1/events

### [#](#_r_8c_--retrieve-kubernetes-events)`get` Retrieve Kubernetes events

Retrieve the k8s events using query parameters.

#### [#](#_r_8c_-parameters)Parameters
...
#### [#](#_r_8c_-response)Response

- `200` [EventsResponse](#_r_8c_-EventsResponse): Successful retrieval of events.

## [#](#_r_8c_-EventsResponse)EventsResponse

- `items`: `[][EventItem](#_r_8c_-EventItem)`List of event items.
...
## [#](#_r_8f_-platformeventsalaudaiov1projectsprojectclustersclusternamespacesnamespaceevents)/platform/events.alauda.io/v1/projects/{project}/clusters/{cluster}/namespaces/{namespace}/events

### [#](#_r_8f_--retrieve-kubernetes-events-for-a-specific-project-and-namespace)`get` Retrieve Kubernetes events for a specific project and namespace
...
#### [#](#_r_8f_-response)Response

- `200` [EventsResponse](#_r_8f_-EventsResponse): Successful retrieval of events.

## [#](#_r_8f_-EventsResponse)EventsResponse

- `items`: `[][EventItem](#_r_8f_-EventItem)`List of event items.

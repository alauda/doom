...
## [#](#_r_23_-pluginsv1alpha1templateprojects)/plugins/v1alpha1/template/projects

### [#](#_r_23_-listprojects)`get`ListProjects

#### [#](#_r_23_-parameters)Parameters
...
#### [#](#_r_23_-response)Response

- `200`[ProjectList](#_r_23_-v1alpha1.ProjectList): OK

### [#](#_r_23_-createproject)`post`CreateProject

#### [#](#_r_23_-request-body)Request Body

[Project](#_r_23_-v1alpha1.Project)required

#### [#](#_r_23_-response-1)Response

- `201`[Project](#_r_23_-v1alpha1.Project): Project Created

## [#](#_r_23_-v1alpha1.ProjectList)ProjectList
...
- `items`: `[][Project](#_r_23_-v1alpha1.Project)`
...
## [#](#_r_23_-v1alpha1.Project)Project
...
- `spec`: [ProjectSpec](#_r_23_-v1alpha1.ProjectSpec)

## [#](#_r_23_-v1alpha1.ProjectSpec)ProjectSpec

- `access`: [Addressable](#_r_23_-v1.Addressable)
- `address`: [Addressable](#_r_23_-v1.Addressable)
- `extendedAddresses`: `map[string][Addressable](#_r_23_-v1.Addressable)`
- `limited`: `boolean`
- `namespaceRefs`: `[][ObjectReference](#_r_23_-v1.ObjectReference)`
- `properties`: `string`
- `public`: `boolean`
- `readOnly`: `boolean`
- `subType`: `string`

## [#](#_r_23_-v1.Addressable)Addressable

- `url`: `string`

## [#](#_r_23_-v1.ObjectReference)ObjectReference

...
## [#](#_r_1h_-platformeventsalaudaiov1events)/platform/events.alauda.io/v1/events

### [#](#_r_1h_-retrieve-kubernetes-events)`get`Retrieve Kubernetes events

Retrieve the k8s events using query parameters.

#### [#](#_r_1h_-parameters)Parameters
...
#### [#](#_r_1h_-response)Response

- `200`[EventsResponse](#_r_1h_-EventsResponse): Successful retrieval of events.

## [#](#_r_1h_-EventsResponse)EventsResponse

- `items`: `[][EventItem](#_r_1h_-EventItem)`List of event items.
...
## [#](#_r_1k_-platformeventsalaudaiov1projectsprojectclustersclusternamespacesnamespaceevents)/platform/events.alauda.io/v1/projects/{project}/clusters/{cluster}/namespaces/{namespace}/events

### [#](#_r_1k_-retrieve-kubernetes-events-for-a-specific-project-and-namespace)`get`Retrieve Kubernetes events for a specific project and namespace
...
#### [#](#_r_1k_-response)Response

- `200`[EventsResponse](#_r_1k_-EventsResponse): Successful retrieval of events.

## [#](#_r_1k_-EventsResponse)EventsResponse

- `items`: `[][EventItem](#_r_1k_-EventItem)`List of event items.

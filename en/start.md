...
For more configuration, see [Configuration](/en/usage/configuration.md)
...
For more configuration, see [Translation Configuration](/en/usage/configuration.md#translate)
...
In addition to exporting a complete PDF document for the entire site, `doom` also supports exporting a single PDF file from a specified entry point. For more configuration, see [Documentation Export Configuration](/en/usage/configuration.md#export)
...
For more configuration, see [Documentation Linting Configuration](/en/usage/configuration.md#lint)
